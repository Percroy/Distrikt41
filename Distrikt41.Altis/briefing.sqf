	...
	player createDiaryRecord["mainrules",
		[
			"Kick- und Bangründe",
				...
				• Cheating<br/>
				• Exploiting<br/>
				• Einbruch in Spielerhäuser und Diebstahl aus deren Kisten<br/>
	...
	player createDiaryRecord ["mainrules",
		[
			"Sonderregeln", 
				...
				Sonderregelungen: Rebellenangriffe, Belagerungen, Sperrzonen und Geiselnahmen<br/>
				...
				2. Sind nicht mindestens 5 Polizisten online, wird jegliche Belagerungen,Rebellenangriffe, Aufstände oder Geiselnahmen als Regelwidrig angesehen. Unterscheidet bitte zwischen Polizisten und der Security.<br/>
				3. Vor einer Belagerung, Rebellenangriff bzw. Aufstand muss man der Polizei eine Liste mit teilnehmenden Spielern/Gruppierungen zukommen lassen.<br/>
	...
	player createDiaryRecord["illegalitems",
		[
			"Illegale Gegenstände",
				...
				- Alle gepanzerten Fahrzeuge (LKws wie Tempest und HEMMT, sowie offene HMMWVs bzw mit Plane und TIGR aus den Gangbasen zählen nicht dazu)<br/>
	...
	player createDiaryRecord ["spawnrules",
		[
			"RDM und VDM", 
				...
				4. Gangkriege müssen der Polizei mitgeteilt werden bzw im Forum gemeldet.
	...
	player createDiaryRecord ["spawnrules",
		[
			"Spawngebiete und Safezones", 
				...
				3. Die Städte Nexoe, Sandvig, Roenne und Aakirvkeby gelten als Safe und Spawnzonen<br/>
				4. Alle Stützpunkte von festen Spielergruppen gelten als Safe und Spawnzonen (siehe Kartenmarkierungen)<br/>
				5. Safezones und Spawngebiete sind mit schwarzen Kreisen makiert.<br/>
				6. Spielerhäuser sind Savezonen und es darf dort weder eingebrochen, noch Gegenstände gestohlen werden sofern die Türen nicht offen stehen.<br/>
				7. Bei Missachtung dieser Regelung wird strikt geahnet: Verwarnung -> Kick -> Ban<br/>
				8. Die Safezoneregelung ist für Spieler, DIE in einer AKTIVEN Verfolgung/Kampf involviert sind in der Zeit aufgehoben!<br/>
				9. Safezonen können nach Absprache mit der Polizei bzw der betroffenen Gang aufgehoben werden (für Terrorwarnungen und große Gefechte z.B.). Hierzu ist mind. 15min vorher eine Ankündigung zu machen! Details dazu siehe Forum distrikt41.de <br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Razzien (Haus / Drogengebiete)", 
				"
				1. Eine Durchsuchung mussen aus mindestens 3 Polizisten und einem Sergeant bestehen.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Luft- und Bodenunterstützung", 
				...
				6. Sollte eine unmittelbare Bedrohung des Lebens eines Polizisten oder Zivilisten bestehen, darf der Blackhawk oder der HMMWV cal50 gegen Personen eingesetzt werden. Die Entscheidung und Verantwortung für den Einsatz obliegt dem Dienstgradhöchsten und ältesten.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["Security",
		[
			"Das Security Unternehmen", 
				"
				Die Security ist ein Sicherheitsunternehmen das sein Gehalt vom Staat bezieht und kostenlose Sicherungsdienste, Transportbegleitung etc anbietet. Sie sind für jeden über den Polizeikanal erreichbar.<br/><br/>
				
				1. Jeder beabsichtigte Regelverstoß wird mit Rauswurf aus der Security geahndet!<br/><br/>
				...
				4. Die MK200, sowie die MXM werden/wird nur dann aus dem Arsenal genommen, wenn ein ranghoher Offizier der Security es gestattet und die Situation es erfordert
				...
				8. Die Security darf sich unter keinen Umständen selbst in den Polizeidienst versetzen (und somit Sonderrechte erhalten).<br/><br/>
				
				9. Die Security unterliegt IMMER der 15 Minuten Spawnregel und überwacht dies in eigener Verantwortung.
				"
		]
	];
	...
	player createDiaryRecord ["gangrules",
		[
			"Gruppenregeln", 
				...
				6. Gangs dürfen sich für einmalige Aktionen verbünden Bank, Geiselnahme, Terrorakt etc. Dies ist VORHER per Sidechat an die Spieler sowie per Nachricht an die Polizei bekannt zu geben.<br/>
				...
				8. Die Regeln 5.-7. gelten sinngemäß für den Zusammenschluss einzelner Spieler mit Gruppierungen.<br/>
				9. Eigene TS-Channel können auf Nachfrage eingerichtet werden nach einer Spielzeit von 2-3 Wochen.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["distriktinfo",
		[
			"Forenadresse und TS-IP", 
				...
				Weitere Infos zum Spiel, Skillsystem, Karma, Shoppreise etc findet ihr unter: wiki.distrikt41.de
	...
	player createDiaryRecord ["controls",
		[
			"Steuerung und Sondertasten",
				...
				F1: Ohrenstöpsel einlegen<br/>
				F4: Zivi: Halt stehen bleiben, Überfall! Pol: Halt stehen bleiben<br/>
				F5: Fahrzeug sofort stoppen und aussteigen!<br/>
				F6: Sofort ergeben und die Waffe weg oder wir schießen!<br/>
				F7: Ich ergebe Mich inkl. Waffen weglegen<br/>
				F8: Nur Aufgeben inkl. Hände über Kopf<br/>
