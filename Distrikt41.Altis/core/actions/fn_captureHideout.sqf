...
if((player distance (getMarkerPos "Ganghideout01")) < 100)	then { "Ganghideout01" setMarkerColor "ColorBlack"; "Ganghideout01" setMarkerText format[localize "STR_D41_Hide_Bravo",(group player) getVariable "gang_name"];};
if((player distance (getMarkerPos "Ganghideout02")) < 100)	then { "Ganghideout02" setMarkerColor "ColorBlack"; "Ganghideout02" setMarkerText format[localize "STR_D41_Hide_Alpha",(group player) getVariable "gang_name"];};
if((player distance (getMarkerPos "Ganghideout03")) < 100)	then { "Ganghideout03" setMarkerColor "ColorBlack"; "Ganghideout03" setMarkerText format[localize "STR_D41_Hide_Charlie",(group player) getVariable "gang_name"];};