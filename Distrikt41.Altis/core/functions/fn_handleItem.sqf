...
//Handy Check
_HandyCheck = ((toArray _item) select [4,5]);
if(toString _HandyCheck isEqualTo "Handy")then
{
	_HandyTyp = toString((toArray _item) select [4,9]);
	if(_HandyTyp isEqualTo "Handy_cop")then	{_item = "D41_Handy_cop";}
	else									{_item = "D41_Handy";};
};
// HandyCheck Ende
