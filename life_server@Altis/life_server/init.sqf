...
{
	private["_dome","_rsb"];
	_dome = nearestObject [[16778.787,13642.496,0],"Land_MilOffices_V1_F"];
	for "_i" from 1 to 8 do {_dome animate [format["Door_%1_rot",_i],0];};
	_dome allowDamage false;
	//Lockup the Wakas
	{
...
[] spawn
{
	_Ganz = createVehicle ["Land_Cargo_House_V3_F", [14281.167,13023.724,-0.5], [], 0, "CAN_COLLIDE"];
	waitUntil{!IsNull _Ganz};    
	_Ganz allowDamage false;
    //_Ganz setDir 0;
    _Ganz animate [format["Door_%1_rot",1],0];
	_Ganz setPosATL [14281.167,13023.724,-0.5];
	D41_Hausliste pushback [14281.167,13023.724,-0.5];	
};
...
tf_radio_channel_password = "123456";
